...
export default function MessageScreen() {
    ...
    const romanticMessage = `Dearest Bhaiya & Bhabhi 💕,

Happy Anniversary to the most wonderful couple! 🥂

Watching the two of you together is truly inspiring. You show everyone what true love, respect, and partnership really look like.

Thank you for being such an amazing part of my life. Seeing you happy makes us all happy. The way you support each other and laugh together is beautiful to witness.

I wish you both endless joy, laughter, and adventures in the years to come. May your bond only grow stronger with every passing day.
                ...
                >
                    <motion.div
                        ...
                        <div className="flex flex-col items-center justify-center h-full p-6">
                            ...
                            <p className="text-purple-300 text-sm">Click to read my wish</p>
                        </div>
                    </motion.div>
                </motion.div>
